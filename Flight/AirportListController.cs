...
{
    public class AirportListController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage AirportList(HttpRequestMessage request)
        {
           ...
           // Password = Convert.ToString(request.Headers.GetValues("ApiPassword").First());
            ...
            return AirportList(requestString);
        }
        ...
        [AcceptVerbs("POST")]
        [HttpPost()]
        public HttpResponseMessage AirportList(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey!=null || apiKey!="") && requestIP!="")
                {
                    ...
                    if (validate)
                    {
                        obj = objProcessor.AirportList(objRQ);
                    }
                    else
                    {
