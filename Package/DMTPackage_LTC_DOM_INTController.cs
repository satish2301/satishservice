...
{
    public class DMTPackage_LTC_DOM_INTController : ApiController
    {
        // GET api/values
        ...
        #region DMTPackage_LTC_DOM_INT
        [AcceptVerbs("POST")]
        [HttpPost()]
        [ActionName("DMTPackage_LTC_DOM_INT")]
        ...
        public HttpResponseMessage GetBankDetails(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    RecommandPackageResponse obj = new RecommandPackageResponse();
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.GetDomIntPkg(objRQ);
                       
                        if (obj != null)
                        {
                            response = JsonConvert.SerializeObject(obj);
                            string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(response), "RecommandPackageResponse");
