...
{
    public class DMTPkgFullDetController : ApiController
    {
        // GET api/values
        ...
        #region DMTPkgFullDet
        [AcceptVerbs("POST")]
        [HttpPost()]
        [ActionName("DMTPkgFullDet")]
        ...
        public HttpResponseMessage GetBankDetails(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    PackageFullDetailResp obj = new PackageFullDetailResp();
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.GetPackageFullDetail(objRQ);
                       
                        if (obj != null)
                        {
                            response = JsonConvert.SerializeObject(obj);
                            string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(response), "PackageFullDetailResp");
