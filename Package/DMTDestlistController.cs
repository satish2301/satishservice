...
{
    public class DMTDestlistController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage GetBankDetails(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    PackageDestiResponse obj = new PackageDestiResponse();
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.Getdesttype(objRQ);
                       
                        if (obj != null)
                        {
                            response = JsonConvert.SerializeObject(obj);
                            string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(response), "PackageDestiResponse");
