...
{
    public class DMTPackageShowController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage GetBankDetails(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    PackageShowResponse obj = new PackageShowResponse();
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.GetPackageShow(objRQ);
                       
                        if (obj != null)
                        {
                            response = JsonConvert.SerializeObject(obj);
                            string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(response), "PackageShowResponse");
