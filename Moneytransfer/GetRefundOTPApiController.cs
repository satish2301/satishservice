...
{
    public class GetRefundOTPController : ApiController
    {
        // GET api/values
        ...
        void AddLogs(string sLogString)
        {
            ...
            Log.Error.LogLogin(Convert.ToString("DMT100"), Convert.ToString(sLogs.ToString()), "DMTRefundgetotpRequest");
        ...
        public HttpResponseMessage GetRefundOTP(string request)
        {
            ...
            try
            {
                ...
                if (request != null)
                {
                    ...
                    Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(requestString), "DMTRefundgetotpRequest");
                    ...
                    if (validate)
                    {
                        ...
                        if (objProcessor.IsJson)
                        {
                            ...
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(response), "DMTRefundgetotpResponse");
