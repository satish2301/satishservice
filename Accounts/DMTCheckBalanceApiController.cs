...
{
    public class DMTCheckBalanceController : ApiController
    {
        // GET api/values
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    CheckBalanceResponse obj = new CheckBalanceResponse();
                        ...
                        Log.Error.LogLogin(Convert.ToString(CompanyId), Convert.ToString(requestString), "BalanceCheckRequest");
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.CheckBalance(objRQ);
                        if (obj != null)
                        {
