            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    if (objProcessor.IsJson)
                        ...
                        Log.Error.LogLogin(Convert.ToString("DMTforhgot"), Convert.ToString(requestString), "forgotRequest");
                    }
                        else
                        {
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.forget_Password(objRQ);
                        if (obj != null)
                        {
                            response = JsonConvert.SerializeObject(obj);
                            string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString("DMTforhgot"), Convert.ToString(response), "forgotResponse");
