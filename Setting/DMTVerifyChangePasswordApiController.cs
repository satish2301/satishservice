...
{
    public class DMTVerifyChangePasswordController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage Token(HttpRequestMessage request)
        {
            ...
            Log.Error.LogLogin(Convert.ToString("finalcheck"), Convert.ToString(requestString), "DMTChangePassVerifyRequest");
        ...
        public HttpResponseMessage DMTSignIns(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    if (validate)
                    {
                        obj = objProcessor.VerifyChangePasswordOTP(objRQ);
                    }
                    else
                    {
