            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    if (validate)
                    {
                        ...
                        if (objRQ.Action.ToLower() == "withdraw")
                            objRQ.Amount=(Convert.ToInt64(objRQ.Amount) + 7);
                    ...
                    {
                        return new HttpResponseMessage { Content = new StringContent("{\"Response\": { \"Status\": \"Fail\",\"Message\": \"Ooops!! bank down.\" }}", System.Text.Encoding.UTF8, "application/json") };
