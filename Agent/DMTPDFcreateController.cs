...
{
    public class DMTPDFcreateController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage GetTokens(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(requestString), "GETPDFRequest");
                    ...
                    if (validate)
                    {
                        if(objRQ.Action=="GETPDF")
                            //obj=objProcessor.getpdf(objRQ);
                        obj = objProcessor.newpdfhtml(objRQ);

                        else
                            obj = objProcessor.getbase64pdf(objRQ);
                        ...
                        if (obj != null)
                        {
                            ...
                            Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(json), "GETPDFResponse");
