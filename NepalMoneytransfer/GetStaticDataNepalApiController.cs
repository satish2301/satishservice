...
{
    public class GetStaticDataNepalController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage CreateCustomer(HttpRequestMessage request)
        {
            ...
            {
                Log.Error.LogLogin(Convert.ToString("EX"), Convert.ToString(requestString), "DMTNepalGetStaticDataRequest");
            }
            ...
            try
            {
                ...
                if (request != null)
                {
                    ...
                    if (objProcessor.IsJson)
                    {
                        ...
                        Log.Error.LogLogin(Convert.ToString(CompanyId), Convert.ToString(requestString), "DMTNepalGetStaticDataRequest");
                    }
                    else
                    {
                    ...
                    if (objProcessor.IsJson)
                    {
                        ...
                        string json = Convert.ToString(response);
                            Log.Error.LogLogin(Convert.ToString(CompanyId), Convert.ToString(json), "DMTNepalGetStaticDataResponse");
