...
{
    public class DMTSignUpController : ApiController
    {
        // GET api/values
        ...
        public HttpResponseMessage SignUp(HttpRequestMessage request)
        {
        ...
        public HttpResponseMessage GetTokens(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    AgentSignUpRequest objRQ = new AgentSignUpRequest();
                    NewSignUpResponse obj = new NewSignUpResponse();
                        if (objProcessor.IsJson)
                        {
                            objRQ = JsonConvert.DeserializeObject<AgentSignUpRequest>(requestString);
                        }
                        else
                        {
                             objRQ = XmlSerializers.DeserializeFromXml<AgentSignUpRequest>(requestString);
                        }
                    ...
                    {
                        // objRQ.ApiPassword
                        obj = objProcessor.SignUpProfile(objRQ);
                        if (obj != null)
                        {
