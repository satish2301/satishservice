...
{
    public class RefundUserController : ApiController
    {
        // GET api/values
        ...
        [AcceptVerbs("POST")]
        [HttpPost()]
        [ActionName("RefundUser")]
        public HttpResponseMessage RefundUser(HttpRequestMessage request)
        {
            ...
            return RefundUser(requestString);
        }
        ...
        [AcceptVerbs("POST")]
        [HttpPost()]
        public HttpResponseMessage RefundUser(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey != null || apiKey != "") && requestIP != "")
                {
                    ...
                    if (validate)
                    {
                        obj = objProcessor.RefundAPI(objRQ);
